/**
 * Tests for ArcIntersectionPoint - a SourcePoint representing where a surface
 * intersects the range limit arc.
 */
...
describe("ArcIntersectionPoint", () => {
  describe("construction and computeXY", () => {
    it("should compute position at t=0 (surface start)", () => {
      ...
      const point = new ArcIntersectionPoint(surface, 0, "range_limit");
    ...
    it("should compute position at t=1 (surface end)", () => {
      const surface = createMockSurface("s1", { x: 100, y: 200 }, { x: 300, y: 400 });
      const point = new ArcIntersectionPoint(surface, 1, "range_limit");
    ...
    it("should compute position at t=0.5 (midpoint)", () => {
      const surface = createMockSurface("s1", { x: 100, y: 200 }, { x: 300, y: 400 });
      const point = new ArcIntersectionPoint(surface, 0.5, "range_limit");
    ...
    it("should compute position at arbitrary t value", () => {
      ...
      const point = new ArcIntersectionPoint(surface, 0.25, "range_limit");
  ...
  describe("type property", () => {
    it("should have type 'intersection'", () => {
      ...
      expect(point.type).toBe("arc_intersection");
    });
  });

  describe("isArcIntersectionPoint type guard", () => {
    it("should return true for ArcIntersectionPoint", () => {
      const surface = createMockSurface("s1", { x: 0, y: 0 }, { x: 100, y: 0 });
      const point = new ArcIntersectionPoint(surface, 0.5, "range_limit");

      expect(isArcIntersectionPoint(point)).toBe(true);
    });

    it("should return false for OriginPoint", () => {
      const point = new OriginPoint({ x: 50, y: 50 });

      expect(isArcIntersectionPoint(point)).toBe(false);
    });
  ...
  describe("isOnSurface", () => {
    ...
    it("should return false for a different surface", () => {
      ...
      const point = new ArcIntersectionPoint(surface1, 0.5, "range_limit");
  ...
  describe("equals", () => {
    it("should return true for same surface and t value", () => {
      const surface = createMockSurface("s1", { x: 0, y: 0 }, { x: 100, y: 0 });
      const point1 = new ArcIntersectionPoint(surface, 0.5, "range_limit");
      const point2 = new ArcIntersectionPoint(surface, 0.5, "range_limit");
    ...
    it("should return false for different t values", () => {
      const surface = createMockSurface("s1", { x: 0, y: 0 }, { x: 100, y: 0 });
      const point1 = new ArcIntersectionPoint(surface, 0.5, "range_limit");
      const point2 = new ArcIntersectionPoint(surface, 0.6, "range_limit");
    ...
    it("should return false for different surfaces", () => {
      const surface1 = createMockSurface("s1", { x: 0, y: 0 }, { x: 100, y: 0 });
      const surface2 = createMockSurface("s2", { x: 0, y: 50 }, { x: 100, y: 50 });
      const point1 = new ArcIntersectionPoint(surface1, 0.5, "range_limit");
      const point2 = new ArcIntersectionPoint(surface2, 0.5, "range_limit");
    ...
    it("should return false when compared to Endpoint at same position", () => {
      const surface = createMockSurface("s1", { x: 0, y: 0 }, { x: 100, y: 0 });
      const intersection = new ArcIntersectionPoint(surface, 0, "range_limit");
  ...
  describe("getKey", () => {
    it("should return unique key with intersection prefix", () => {
      ...
      expect(key).toContain("arc_intersection:");
  ...
  describe("intersectionType", () => {
    ...
    it("should store surface intersection type", () => {
      const surface = createMockSurface("s1", { x: 0, y: 0 }, { x: 100, y: 0 });
      const point = new ArcIntersectionPoint(surface, 0.5, "surface");
